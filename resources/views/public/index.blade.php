...
<body class="bg-gray-50 pb-32" x-data="shop()" x-init="initCart()">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between py-3 md:py-4 gap-4">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <!-- Tombol Admin (Mobile) -->
                    <a href="{{ route('login') }}" class="md:hidden p-2 bg-gray-100 rounded-full text-gray-400 hover:text-orange-600 transition">
                ...
                <div class="flex flex-col md:flex-row gap-3 w-full md:w-auto md:flex-1 md:justify-end md:items-center">
                    ...
                    <a href="{{ route('login') }}" class="hidden md:flex items-center gap-2 px-4 py-2.5 bg-gray-900 text-white rounded-xl text-sm font-bold hover:bg-gray-800 transition shadow-lg shadow-gray-200">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <!-- 2. PROMO BANNER (DENGAN ANIMASI TYPEWRITER) -->
        ...
        <!-- 3. MENU GRID (Responsive: HP 2, Laptop 5) -->
        @if(request('search'))
                ...
                <div class="group bg-white rounded-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.05)] hover:shadow-[0_10px_30px_rgba(0,0,0,0.1)] transition-all duration-300 border border-gray-100 overflow-hidden flex flex-col h-full relative transform hover:-translate-y-1">
                    ...
                    <div class="p-4 flex flex-col flex-1">
                        ...
                        <div class="mt-auto pt-3 border-t border-dashed border-gray-100 flex items-end justify-between gap-2">
                            ...
                            @if($menu->stock > 0)
                                <button @click="addToCart({{ $menu->id }}, '{{ $menu->name }}', {{ $finalPrice }}, '{{ $menu->image }}', $event)"
        ...
        <div class="mt-16 pt-10 border-t border-gray-200">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div class="bg-white rounded-3xl p-6 md:p-8 shadow-xl shadow-gray-200/50 border border-gray-100 relative overflow-hidden">
                    ...
                    @if(session('success'))
                        <div class="bg-green-50 text-green-700 p-4 rounded-xl text-sm font-medium mb-6 border border-green-100">
                            {{ session('success') }}
                        </div>
                    @endif
                ...
                <div class="relative w-10 h-10 flex items-center justify-center rounded-xl bg-orange-500 shadow-lg shadow-orange-500/40">
                    ...
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13l-1.3 5.2A1 1 0 006.7 20h10.6a1 1 0 001-.8L20 13M7 13h10" />
                    </svg>
                    ...
                    >
                        <span
                            :class="pulse ? 'animate-ping' : ''"
                            class="absolute inline-flex h-full w-full rounded-full bg-red-500 opacity-75">
                        </span>

                        <span
                            x-text="totalQty()"
                            class="relative bg-red-600 text-white text-[10px] font-bold w-5 h-5 flex items-center justify-center rounded-full border-2 border-gray-900">
                        </span>
                    </span>
    ...
    <div x-show="showModal" x-cloak class="fixed inset-0 z-50 flex items-end justify-center sm:items-center">
        <div @click="showModal = false" x-show="showModal" x-transition.opacity class="absolute inset-0 bg-black/60 backdrop-blur-sm cursor-pointer"></div>
                    ...
                    <div class="flex justify-between items-center bg-gray-50 p-3 rounded-xl border border-gray-100">
                        <div class="flex items-center gap-3">
                            <div class="w-12 h-12 bg-gray-200 rounded-lg overflow-hidden flex-shrink-0">
                                ...
                                <template x-if="!item.image">
                                    <div class="w-full h-full flex items-center justify-center text-gray-400 text-xs font-bold">IMG</div>
                                </template>
                            </div>
                            <div class="flex flex-col">
            ...
            return {
                ...
                flyToCart(event) {
                    ...
                    fly.animate([
                        ...
                        {
                            transform: `translate(${rectTo.left - rectFrom.left}px, ${rectTo.top - rectFrom.top}px) scale(0.2)`,
                            opacity: 0
                        }
                    ], {
                        duration: 600,
